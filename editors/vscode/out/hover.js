...
class GoplusHoverProvider {
    async findDefinitionAndHover(document, position, word) {
    ...
    async hoverDecorator(document, position, name, lineText) {
    ...
    async hoverImportPath(importPath, documentPath) {
