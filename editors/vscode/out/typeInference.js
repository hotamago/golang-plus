...
exports.inferTypeOfVariable = inferTypeOfVariable;
exports.inferTypeFromExpression = inferTypeFromExpression;
const vscode = __importStar(require("vscode"));
async function inferTypeOfVariable(document, position, variableName) {
    let rhs;
...
async function inferTypeFromExpression(document, expr) {
    // String literal
...
async function getFunctionReturnType(fnName) {
